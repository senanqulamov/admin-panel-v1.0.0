            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.service.category.index') }}" class="text-muted">Xidmətlər</a>
                        </li>
            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.service.category.store') }}"
                                  method="POST"
                            >
                                @csrf
                                                ...
                                                <div style="padding: 0.25rem;" class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  form="submit-form" class="form-control countriesOverflow selectpicker"
                                                            ...
                                                            {{ \App\Services\ServicesService::getTree($defaultLanguage) }}
                                                        </select>
