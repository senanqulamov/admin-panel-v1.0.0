        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Slaydlar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        @isset($searchText)
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.language.index') }}" class="text-muted">Slaydlar</a>
                            </li>
                            <li class="breadcrumb-item">
                                Axtar
                            </li>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex align-items-center py-3">
                            <span class="text-muted">
                                Cəmi <b><span class="totalCount">{{ $slides->total() }}</span></b> yazı
                                @if($slides->hasPages())
                                    , <b>{{ $slides->lastPage() }}
                                </b> səhifədən  <b>{{ $slides->currentPage() }}</b>-ci göstərildi.
                                @endif
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $slides->appends(['search' => isset($searchText) ? $searchText : null])
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.statusActive', function () {
                ...
                $.ajax({
                    url: "{{ route('admin.slide.statusAjax') }}",
                    type: 'POST',
        ...
        function saveNewPositions() {
            ...
            $.ajax({
                url: "{{ route('admin.slide.sortAjax') }}",
                method: 'POST',
                dataType: 'JSON',
        ...
        $(document).on('click', '.deleteButton', function () {
            ...
            $.ajax({
                url: "{{ route('admin.slide.deleteAjax') }}",
                type: 'POST',
                data: {id: slideID},
                dataType: 'JSON',
                success: function (response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            title: "Diqqət?",
                            html: "Slaydı silmək istədiyinizə əminsiniz?",
                            icon: "error",
