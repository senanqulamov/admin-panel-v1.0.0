        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Bloq Kateqoriyalar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped" data-sorting="true">
                        ...
                        @foreach($postCategories as $key => $postCategory)
                            ...
                            <tr class="table-id-{{ $postCategory->id }}" data-index="{{ $postCategory->id }}"
                                data-position="{{ $postCategory->sort }}">
                                ...
                                <!--  SAY  -->
                                <td>
                                    <a href="{{ route('admin.post.categories',$postCategory->id) }}">{{ count($postCategories[$key]->getPostsCount) }}</a>
                                </td>
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right"
                                            ...
                                            <ul class="navi navi-hover">
                                                ...
                                                <li
                                                    ...
                                                    <a href="{{ route('admin.post.category.edit',$postCategory->id) }}"
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $postCategories->appends(['search' => isset($searchText) ? $searchText : null])
