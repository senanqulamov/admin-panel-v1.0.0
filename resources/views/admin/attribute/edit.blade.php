            ...
            <div class="row">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Atribut redaktə et</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.attribute.update') }}"
                                          method="POST">
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select form="submit-form"
                                                    ...
                                                    @foreach($attributeGroups as $attributeGroup)
                                                        <option
                                                            @if(old('attribute_group_id') != null)
                                                            {{ old('attribute_group_id') == $attributeGroup->id ? 'selected' : '' }}
                                                            @else
                                                            {{ old('attribute_group_id',$attributeGroup->id) == $attribute->attribute_group_id ? 'selected' : '' }}
                                                            @endif
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <input type="hidden" form="submit-form" name="id" value="{{ $attribute->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        <option {{ $attribute->status == 1?'selected':'' }} value="1">Aktiv</option>
                                        <option {{ $attribute->status == 0?'selected':'' }} value="0">Passiv</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ \Illuminate\Support\Carbon::parse($attribute->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
