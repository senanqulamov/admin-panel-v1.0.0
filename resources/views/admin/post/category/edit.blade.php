            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.post.index') }}" class="text-muted">Bloqlar</a>
                        </li>

                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.post.category.index') }}" class="text-muted">Kateqoriyalar</a>
                        </li>
            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.post.category.update') }}"
                                  method="POST"
                            >
                                @csrf
                                                ...
                                                <div style="padding: 0.25rem;" class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  form="submit-form" class="form-control countriesOverflow selectpicker"
                                                            ...
                                                            {{ \App\Services\PostsService::getEditTree($defaultLanguage,$postCategory->parent) }}
                                                        </select>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('name.'. $language->id,getTranslateData($postCategory->postsCategoriesTranslations,$language->id,'name')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class="tinymceEditor form-control">{{ old('text.'. $language->id,getTranslateData($postCategory->postsCategoriesTranslations,$language->id,'text')) }}</textarea>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('title.'. $language->id,getTranslateData($postCategory->postsCategoriesTranslations,$language->id,'title')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('keyword.'. $language->id,getTranslateData($postCategory->postsCategoriesTranslations,$language->id,'keyword')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class=" form-control">{{ old('description.'. $language->id,getTranslateData($postCategory->postsCategoriesTranslations,$language->id,'description')) }}</textarea>
                                                                    ...
                                                                    @foreach(cache('key-all-languages') as $key => $language)
                                                                        <div class="input-group mt-2">
                                                                            ...
                                                                            <input
                                                                                style="height: 21px;"
                                                                                type="text" readonly
                                                                                value="{{$language->code == cache('language-default') ? "": "/".$language->code}}/post/category/{{ $postCategory->slug }}"
                                                                                class="form-control">
                                                                        </div>
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <!--  ID  -->
                            <input type="hidden" form="submit-form" name="id" value="{{ $postCategory->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        <option {{ $postCategory->status == 1?'selected':'' }} value="1">Aktiv</option>
                                        <option {{ $postCategory->status == 0?'selected':'' }} value="0">Passiv</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ \Illuminate\Support\Carbon::parse($postCategory->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
                                        <div>Tarix yenilənmə:</div>
                                        <div>{{ updateDate($postCategory->updated_at,$postCategory->postsCategoriesTranslations) }}</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div
                                        ...
                                        <div class="images-post-item">
                                            ...
                                            <div
                                                style="display: {{ old('image',$postCategory->image) == null? 'none':'flex' }}"
                                                tooltip="Sil"
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{old('image',$postCategory->image) == null ? asset('storage/no-image.png'): old('image',$postCategory->image) }}"
                                                    class="previewImage"
                                                >
                                    ...
                                    <div class="image-post-input">
                                        <input type="text"
                                               id="image_label"
                                               name="image"
                                               value="{{ old('image',$postCategory->image) }}"
                                               form="submit-form"
                                        >
