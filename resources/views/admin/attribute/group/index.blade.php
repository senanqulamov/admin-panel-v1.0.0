        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Atribut Qruplar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Atribut Qruplar</h3>
                    </div>
                            ...
                            <tr class="table-id-{{ $attributesGroup->id }}" data-index="{{ $attributesGroup->id }}"
                                ...
                                <td width="100">
                                        ...
                                        <label>
                                            <input
                                                class="statusActive"
                                                data-id="{{ $attributesGroup->id }}"
                                                type="checkbox"
                                                {{ $attributesGroup->status == 1? 'checked="checked"':"" }}
                                                name="select">
                                            <span></span>
                                        </label>
									</span>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex align-items-center py-3">
                            <span class="text-muted">
                                Cəmi <b><span class="totalCount">{{ $attributesGroups->total() }}</span></b> yazı
                                @if($attributesGroups->hasPages())
                                    , <b>{{ $attributesGroups->lastPage() }}
                                </b> səhifədən  <b>{{ $attributesGroups->currentPage() }}</b>-ci göstərildi.
                                @endif
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $attributesGroups->appends(['search' => isset($searchText) ? $searchText : null])
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.statusActive', function () {
                ...
                $.ajax({
                    url: "{{ route('admin.attribute.group.statusAjax') }}",
                    type: 'POST',
        ...
        function saveNewPositions() {
            ...
            $.ajax({
                url: "{{ route('admin.attribute.group.sortAjax') }}",
                method: 'POST',
                dataType: 'JSON',
        ...
        {{--    $.ajax({--}}
        {{--        url: "{{ route('admin.attribute.group.deleteAjax') }}",--}}
        {{--        type: 'POST',--}}
        {{--        data: {id: slideID},--}}
        {{--        dataType: 'JSON',--}}
        {{--        success: function (response) {--}}
        ...
        {{--                Swal.fire({--}}
        {{--                    title: "Diqqət?",--}}
        {{--                    html: "Atribut qrupu silmək istədiyinizə əminsiniz?",--}}
        {{--                    icon: "error",--}}
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        if (response.error == null) {
                            ...
                            Swal.fire({
                                title: "Diqqət?",
                                html: "Atribut qrupunu silmək istədiyinizə əminsiniz?",
                                icon: "error",
                                showCancelButton: true,
                                confirmButtonText: "Sil!",
                                cancelButtonText: "Xeyir",
                            ...
                            Swal.fire({
                                title: "Diqqət!",
                                html: "Bu atribut qrupunu silmək olmaz! <b>" + response.name + "</b> atribut qrupunu aid atributlar var!",
                                icon: "error",
