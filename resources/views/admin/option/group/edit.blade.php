            ...
            <div class="row">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Seçim qrup redaktə et</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.option.group.update') }}"
                                          method="POST">
                                        @csrf
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('name.'. $language->id,getTranslateData($optionGroup->optionsGroupsTranslations,$language->id,'name')) }}"
                                                                                class="form-control">
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <input type="hidden" form="submit-form" name="id" value="{{ $optionGroup->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        <option {{ $optionGroup->status == 1?'selected':'' }} value="1">Aktiv</option>
                                        <option {{ $optionGroup->status == 0?'selected':'' }} value="0">Passiv</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" min="0" form="submit-form" class="form-control" name="sort" value="{{ old('sort',$optionGroup->sort) }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ \Illuminate\Support\Carbon::parse($optionGroup->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
                                        <div>Tarix yenilənmə:</div>
                                        <div>{{ updateDate($optionGroup->updated_at,$optionGroup->optionsGroupsTranslations) }}</div>
                                    </div>
                                </div>
                            </div>
