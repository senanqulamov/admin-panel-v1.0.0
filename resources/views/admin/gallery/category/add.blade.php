            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.gallery.category.store') }}"
                                  method="POST"
                            >
                                @csrf
                                                ...
                                                <div style="padding: 0.25rem;" class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  form="submit-form" class="form-control countriesOverflow selectpicker"
                                                            ...
                                                            {{ \App\Services\CategoriesService::getTree($defaultLanguage) }}
                                                        </select>
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="number" style="max-width: 100px" name="sort"  min="0" class="form-control" value="{{ old('sort',0) }}" form="submit-form">
                                </div>
                            </div>
