        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Xidmət Kateqoriyalar Axtar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.service.category.index') }}" class="text-muted">Xidmət Kateqoriyalar</a>
                        </li>
                        <li class="breadcrumb-item">
                            Axtar
                        </li>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped" data-sorting="true">
                        ...
                        @foreach($serviceCategories as $key => $serviceCategory)
                            ...
                            <tr class="table-id-{{ $serviceCategory->id }}" data-index="{{ $serviceCategory->id }}" data-position="{{ $serviceCategory->sort }}">

                                <!-- SELECT ALL -->
                                <td>
                                    <label class="checkbox checkbox-success select-element-btn" data-id="{{ $serviceCategory->id }}">
                                        <input type="checkbox"   />
                                        <span></span>
                                    </label>
                                </td>
                                ...
                                <td>
                                    ...
                                    {{--                                    <a href="{{ route('admin.service.category.edit',$serviceCategory->id) }}">{{ $serviceCategory->servicesCategoriesTranslations[0]->name }}</a>--}}
                                </td>

                                <!--  SAY  -->
                                <td><a href="{{ route('admin.service.categories',$serviceCategory->id) }}">{{ count($serviceCategories[$key]->getServicesCount) }}</a></td>


                                <!--  Tarix  -->
                                <td>{{ updateDate($serviceCategory->updated_at,$serviceCategory->servicesCategoriesTranslations) }}</td>
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right"
                                            ...
                                            <ul class="navi navi-hover">
                                                ...
                                                <li
                                                    ...
                                                    <a href="{{ route('admin.service.category.edit',$serviceCategory->id) }}" class="navi-link text-center">
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $serviceCategories->appends(['search' => request('search')])
...
@section('js')
    ...
    <script>
        deleteALlSelectedElements(
            ...
            'Sil!',
            'Xeyir',
            '{{ route('admin.service.category.allDeleteAjax') }}',
