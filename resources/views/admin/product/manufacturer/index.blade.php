        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Məhsullar İstehsalçılar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Məhsullar İstehsalçılar</h3>
                    </div>
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $productManufacturers->appends(['search' => isset($searchText) ? $searchText : null])
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        if(response.error == null){
                            ...
                            Swal.fire({
                                title: "Diqqət!",
                                html: "Bu istehsalçını silmək olmaz! <b>" + response.name + "</b> istehsalçısına aid məhsullar var!",
                                icon: "error",
