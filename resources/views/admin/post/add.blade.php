...
{{--                                    </li>--}}
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.post.store') }}"
                                  method="POST"
                            >
                                @csrf
                                                                        ...
                                                                        @if(old('images') != null)
                                                                            @foreach(old('images') as $iamge)
                                                                                <div class="images-box-item">
                                                                                    ...
                                                                                    <input form="submit-form" type="hidden" name="images[]" value="{{ $iamge }}">
                                                                                </div>
                                                                            @endforeach
                                                                        @endif
                                                                    </div>
...
{{--                                        {{ \App\Services\PostsService::getTreePostCategories($defaultLanguage) }}--}}
