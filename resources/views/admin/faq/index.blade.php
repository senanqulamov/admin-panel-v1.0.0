        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Faqlar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        @isset($searchText)
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.language.index') }}" class="text-muted">Faqlar</a>
                            </li>
                            <li class="breadcrumb-item">
                                Axtar
                            </li>
...
{{--                        </div>--}}
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped" data-sorting="true">
                        ...
                        <tbody id="sortable">
                        @foreach($faqs as $faq)
                            <tr class="table-id-{{ $faq->id }}" data-index="{{ $faq->id }}" data-position="{{ $faq->sort }}">


                                <!-- SELECT ALL -->
                                <td>
                                    <label class="checkbox checkbox-success select-element-btn" data-id="{{ $faq->id }}">
                                        <input type="checkbox"   />
                                        <span></span>
                                    </label>
                                </td>
                                ...
                                <!-- Title -->
                                <td class="sortableHandle">{{ $faq->faqsTranslations[0]->title }}</td>



                                <!--  Tarix  -->
                                <td>{{ updateDate($faq->updated_at,$faq->faqsTranslations) }}</td>
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right"
                                            ...
                                            <ul class="navi navi-hover">
                                                ...
                                                <li
                                                    ...
                                                    <a href="{{ route('admin.faq.edit',$faq->id) }}" class="navi-link text-center">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex align-items-center py-3">
                            <span class="text-muted">
                                Cəmi <b><span class="totalCount">{{ $faqs->total() }}</span></b> yazı
                                @if($faqs->hasPages())
                                    , <b>{{ $faqs->lastPage() }}
                                </b> səhifədən  <b>{{ $faqs->currentPage() }}</b>-ci göstərildi.
                                @endif
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $faqs->appends(['search' => isset($searchText) ? $searchText : null])
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.statusActive', function () {
                ...
                $.ajax({
                    url: "{{ route('admin.faq.statusAjax') }}",
                    type: 'POST',
        ...
        $(document).on('click', '.deleteButton', function () {
            ...
            $.ajax({
                url: "{{ route('admin.faq.deleteAjax') }}",
                type: 'POST',
                data: {id: faqID},
                dataType: 'JSON',
                success: function (response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            title: "Diqqət?",
                            html: "Faqı silmək istədiyinizə əminsiniz?",
                            icon: "error",
