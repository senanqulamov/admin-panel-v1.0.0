        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Bloqlar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Bloqlar</h3>
                    </div>
...
{{--                            <th data-breakpoints="xs sm md" data-sortable="false">Kateqoriya</th>--}}
                        ...
                        @foreach($posts as $post)
                            ...
                            <tr class="table-id-{{ $post->id }}" data-index="{{ $post->id }}"
                                data-position="{{ $post->sort }}">
                                ...
                                <!--  NAME  -->
                                <td>
                                    <a href="{{ route('admin.post.edit',$post->id) }}">{{ $post->postsTranslations[0]->name }}</a>
                                </td>
