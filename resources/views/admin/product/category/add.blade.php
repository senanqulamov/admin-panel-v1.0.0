            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.product.category.store') }}"
                                  method="POST"
                            >
                                @csrf
                                                ...
                                                <div style="padding: 0.25rem;" class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select  form="submit-form" class="form-control countriesOverflow selectpicker"
                                                            ...
                                                            {{ \App\Services\CategoriesService::getTreeProduct($defaultLanguage) }}
                                                        </select>
