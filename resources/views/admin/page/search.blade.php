        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Səhifələr</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Səhifələr</h3>
                    </div>
                        ...
                        @foreach($pages as $page)
                            <tr class="table-id-{{ $page->id }}" data-index="{{ $page->id }}" data-position="{{ $page->sort }}">
                               ...
                               <!-- ID -->
                                ...
                                <!--  NAME  -->
                                <td><a href="{{ route('admin.page.edit',$page->id) }}">{{ $page->name }}</a></td>

                                <!--  Tarix  -->
                                <td>{{ \Illuminate\Support\Carbon::parse($page->updated_at)->format('Y-m-d H:i') }}</td>
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex align-items-center py-3">
                            <span class="text-muted">
                                Cəmi <b><span class="totalCount">{{ $pages->total() }}</span></b> yazı
                                @if($pages->hasPages())
                                    , <b>{{ $pages->lastPage() }}
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            title: "Diqqət?",
                            html: "Səhifəni silmək istədiyinizə əminsiniz?",
                            icon: "error",
