            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.product.model.update') }}"
                                  method="POST"
                            >
                                @csrf
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('name.'. $language->id,getTranslateData($productModel->productsModelsTranslations,$language->id,'name')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class="tinymceEditor form-control">{{ old('text.'. $language->id,getTranslateData($productModel->productsModelsTranslations,$language->id,'text')) }}</textarea>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('title.'. $language->id,getTranslateData($productModel->productsModelsTranslations,$language->id,'title')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('keyword.'. $language->id,getTranslateData($productModel->productsModelsTranslations,$language->id,'keyword')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class=" form-control">{{ old('description.'. $language->id,getTranslateData($productModel->productsModelsTranslations,$language->id,'description')) }}</textarea>
                                                            ...
                                                            <!--  SLUG START  -->
                                                                <div class="form-group">
                                                                    ...
                                                                    <input
                                                                        type="text"
                                                                        name="slug"
                                                                        value="{{ old('slug',$productModel->slug) }}"
                                                                        class=" form-control">
                                                                    @error('slug' )<span
                                                                    ...
                                                                    @foreach(cache('key-all-languages') as $key => $language)
                                                                        <div class="input-group mt-2">
                                                                            ...
                                                                            <input
                                                                                style="height: 21px;"
                                                                                type="text" readonly
                                                                                value="{{$language->code == cache('language-default') ? "": "/".$language->code}}/products/model/{{ $productModel->slug }}"
                                                                                class="form-control">
                                                                        </div>
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <!--  ID  -->
                            <input type="hidden" form="submit-form" name="id" value="{{ $productModel->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        <option {{ $productModel->status == 1?'selected':'' }} value="1">Aktiv</option>
                                        <option {{ $productModel->status == 0?'selected':'' }} value="0">Passiv</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ \Illuminate\Support\Carbon::parse($productModel->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
                                        <div>Tarix yenilənmə:</div>
                                        <div>{{ updateDate($productModel->updated_at,$productModel->productsModelsTranslations) }}</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div
                                        ...
                                        <div class="images-post-item">
                                            ...
                                            <div
                                                style="display: {{ old('image',$productModel->image) == null? 'none':'flex' }}"
                                                tooltip="Sil"
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{old('image',$productModel->image) == null ? asset('storage/no-image.png'): old('image',$productModel->image) }}"
                                                    class="previewImage"
                                                >
                                    ...
                                    <div class="image-post-input">
                                        <input type="text"
                                               id="image_label"
                                               name="image"
                                               value="{{ old('image',$productModel->image) }}"
                                               form="submit-form"
                                        >
