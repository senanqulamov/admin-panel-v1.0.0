...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    ...
                    <a href="javascript:void(0)" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5"
                       onclick="document.getElementById('formLogout').submit()">Çıxış et</a>
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="{{ route('admin.user.profilEdit',auth()->user()->id) }}" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">Profil ayarları</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
...
<!--  Toastr ALert START  -->
<script src="{{ asset('backend/assets/js/pages/features/miscellaneous/toastr.js') }}"></script>
<!--  Toastr ALert END  -->

<!--  Footable  -->
<script src='{{ asset('backend/assets/plugins/footable/js/footable.min.js') }}'></script>

<!--  Clipboard  -->
<script src="{{ asset('backend/assets/js/pages/crud/forms/widgets/clipboard.js') }}"></script>
...
<!--  CUSTOM SCRIPT  -->
<script>
    const noPhoto = "{{ asset('storage/no-image.png') }}";
    const langaugeDefault = "{{ cache('language-default') }}";
    const appUrl = "{{ env('APP_URL') }}";

    const cacheClearRoute = "{{ route('admin.cacheClear') }}";
    const cacheClear = "Keş təmizləndi";
</script>
...
<!--  Sweet Alert Share View  -->
@isset($sweetAlertSuccess)
    {!! $sweetAlertSuccess !!}
@endisset
...
<!--  Alert Toast Share View  -->
@if(Session::has('alertToastSuccess'))
    @foreach(Session::get('alertToastSuccess') as $alerts)
        {!! $alerts !!}
    @endforeach
@endif
