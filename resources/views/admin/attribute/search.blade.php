        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Atributlar Axtar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Atributlar Axtar</h3>
                    </div>
                                ...
                                <td width="100">
                                        ...
                                        <label>
                                            <input
                                                ...
                                                type="checkbox"
                                                {{ $attribute->status == 1? 'checked="checked"':"" }}
                                                name="select">
                                            <span></span>
                                        </label>
									</span>
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right"
                                            ...
                                            <ul class="navi navi-hover">
                                                ...
                                                <li
                                                    ...
                                                    <a href="{{ route('admin.attribute.edit',$attribute->id) }}" class="navi-link text-center">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex align-items-center py-3">
                            <span class="text-muted">
                                Cəmi <b><span class="totalCount">{{ $attributes->total() }}</span></b> yazı
                                @if($attributes->hasPages())
                                    , <b>{{ $attributes->lastPage() }}
                                </b> səhifədən  <b>{{ $attributes->currentPage() }}</b>-ci göstərildi.
                                @endif
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $attributes->appends(['search' => isset($searchText) ? $searchText : null])
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.statusActive', function () {
                ...
                $.ajax({
                    url: "{{ route('admin.attribute.statusAjax') }}",
                    type: 'POST',
        ...
        function saveNewPositions() {
            ...
            $.ajax({
                url: "{{ route('admin.attribute.sortAjax') }}",
                method: 'POST',
                dataType: 'JSON',
        ...
        $(document).on('click', '.deleteButton', function () {
            ...
            $.ajax({
                url: "{{ route('admin.attribute.deleteAjax') }}",
                type: 'POST',
                data: {id: slideID},
                dataType: 'JSON',
                success: function (response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            title: "Diqqət?",
                            html: "Atributu silmək istədiyinizə əminsiniz?",
                            icon: "error",
