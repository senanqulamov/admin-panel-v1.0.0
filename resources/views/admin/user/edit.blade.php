                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">İstifadəçi redaktə et</h3>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.user.update') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-15">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="username" type="text" name="username" value="{{ old('username',$user->username) }}" class="form-control form-control-lg"   placeholder="İstifadəçi adı"/>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input id="name" type="text" name="name" value="{{ old('name',$user->name) }}" class="form-control form-control-lg"   placeholder="Ad soyad"/>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <select class="form-control" name="status" id="status">
                                                            <option {{ $user->status == 0 ? 'selected':null }} value="0">Passiv</option>
                                                            <option {{ $user->status == 1 ? 'selected':null }} value="1">Aktiv</option>
                                                        </select>
