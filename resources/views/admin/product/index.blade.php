        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Məhsullar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        @if(isset($parentProduct))
                            <h3 class="card-label">Alt mehsullar</h3>
                        @else
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped" data-sorting="true">
                        ...
                        <tr>
                            ...
                            @if(isset($parentProduct))
                                <th data-breakpoints="xs sm md" data-sortable="false">Ana məhsul</th>
                            @else
                                <th data-breakpoints="xs sm md" data-sortable="false">Alt məhsul</th>
                            @endif
                        ...
                        @foreach($products as $product)
                            ...
                            <tr  class="table-id-{{ $product->id }}" data-index="{{ $product->id }}"
                                ...
                                @if(isset($parentProduct))
                                        <a href="{{ route('admin.product.edit',$parentProduct->productsTranslations[0]->product_id) }}">
                                            {{ $parentProduct->productsTranslations[0]->name }}
                                        </a>
                                @else
                                    @if(empty($product->childrens->count()))
                                        0
                                    @else
                                        <a href="{{ route('admin.product.parents',$product->id) }}">{{ $product->childrens->count() }}</a>
                                        @endif
                                @endif
                                ...
                                <td>{!!
                                      product_price(
                                         $product->price,
                                         $product->productSpecialPriceList != null ? $product->productSpecialPriceList['special_price']: '',
                                         $product->productSpecialPriceList != null ? $product->productSpecialPriceList['start_date']: '',
                                         $product->productSpecialPriceList != null ? $product->productSpecialPriceList['end_date']: '',
                                     )
                                     !!}
                                </td>
