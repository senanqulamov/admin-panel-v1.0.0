        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Bloqlar Axtar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Bloqlar Axtar</h3>
                    </div>
                            ...
                            <tr class="table-id-{{ $post->id }}" data-index="{{ $post->id }}" data-position="{{ $post->sort }}">
                                ...
                                <td>
                                    <div style="vertical-align: middle;" class="iamge-table">
                                        ...
                                        @if(empty($post->image))
                                            <img src="{{ asset('storage/no-image.png') }}"alt="{{$post->name}}">
                                        @else
                                ...
                                <!--  Kateqoriyalar  -->
{{--                                <td>--}}
{{--                                    @foreach($post->postsCategories as $category)--}}
{{--                                        <a href="{{ route('admin.post.categories',$category->category_id) }}">{{ \App\Services\PostsService::getCategoryName($category->category_id,$defaultLanguage)->name }}</a>--}}
{{--                                        @if (!$loop->last)--}}
{{--                                            ,--}}
{{--                                        @endif--}}
{{--                                    @endforeach--}}
...
{{--                                </td>--}}
                                ...
                                <!--  Tarix  -->
                                <td>{{ \Illuminate\Support\Carbon::parse($post->updated_at)->format('Y-m-d H:i') }}</td>
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right"
                                            ...
                                            <ul class="navi navi-hover">
                                                ...
                                                <li
                                                    ...
                                                    <a href="{{ route('admin.post.edit',$post->id) }}" class="navi-link text-center">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex align-items-center py-3">
                            <span class="text-muted">
                                Cəmi <b><span class="totalCount">{{ $posts->total() }}</span></b> yazı
                                @if($posts->hasPages())
                                    , <b>{{ $posts->lastPage() }}
                                </b> səhifədən  <b>{{ $posts->currentPage() }}</b>-ci göstərildi.
                                @endif
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.statusActive', function () {
                ...
                $.ajax({
                    url: "{{ route('admin.post.statusAjax') }}",
                    type: 'POST',
        ...
        $(document).on('click', '.deleteButton', function () {
            ...
            $.ajax({
                url: "{{ route('admin.post.deleteAjax') }}",
                type: 'POST',
                data: {id: dataID},
                dataType: 'JSON',
