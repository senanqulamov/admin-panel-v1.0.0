            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.banner.index') }}" class="text-muted">Bannerlər</a>
                        </li>
            ...
            <div class="row">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Banner redaktə et</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.banner.update') }}"
                                          method="POST">
                                        @csrf
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        @foreach(cache('key-all-languages') as $key => $language)
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="hr-dvidder d-none"></div>
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <input type="hidden" form="submit-form" name="id" value="{{ $banner->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        <option {{ $banner->status == 1?'selected':'' }} value="1">Aktiv</option>
                                        <option {{ $banner->status == 0?'selected':'' }} value="0">Passiv</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ \Illuminate\Support\Carbon::parse($banner->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
                            ...
                            <div class="form-group">
                                <div class="radio-list">
                                    <label class="radio">
                                        ...
                                        <input form="submit-form" type="radio" {{ old('position',$banner->position) == 2 ? 'checked': null }} name="position" value="2">
                                        <span></span>Sol</label>
                                    <label class="radio">
                                        <input form="submit-form"  type="radio" {{ old('position',$banner->position) == 1 ? 'checked': null }} name="position" value="1">
                                        <span></span>Orta</label>
                                    <label class="radio">
                                        <input form="submit-form" type="radio" {{ old('position',$banner->position) == 3 ? 'checked': null }}  name="position" value="3">
                                        <span></span>Sağ</label>
                                </div>
                            </div>
