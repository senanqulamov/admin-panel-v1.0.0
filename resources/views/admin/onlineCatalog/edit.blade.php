            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.onlineCatalog.index') }}" class="text-muted">Onlayn Kataloqlar</a>
                        </li>
            ...
            <div class="row">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">Onlayn Kataloq redaktə et</h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <form class="form" id="submit-form" action="{{ route('admin.onlineCatalog.update') }}"
                                          method="POST">
                                        @csrf
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea
                                                                        ...
                                                                        class="tinymceEditor form-control">{{ old('title.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'title')) }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea
                                                                        ...
                                                                        class="tinymceEditor form-control">{{ old('sub_title.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'sub_title')) }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           value="{{ old('button_name.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'button_name')) }}">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           value="{{ old('button_url.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'button_url')) }}">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div id="text-color-{{$language->id}}" class="input-group">
                                                                        <input type="text"
                                                                               ...
                                                                               value="{{ old('color.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'color')) }}"
                                                                        >
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            <input type="hidden" form="submit-form" name="id" value="{{ $onlineCatalog->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        <option {{ $onlineCatalog->status == 1?'selected':'' }} value="1">Aktiv</option>
                                        <option {{ $onlineCatalog->status == 0?'selected':'' }} value="0">Passiv</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ \Illuminate\Support\Carbon::parse($onlineCatalog->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
                                        <div>Tarix yenilənmə:</div>
                                        <div>{{ updateDate($onlineCatalog->updated_at,$onlineCatalog->onlineCatalogsTranslations) }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="radio-list">
                                    <label class="radio">
                                        ...
                                        <input form="submit-form" type="radio" {{ old('position',$onlineCatalog->position) == 2 ? 'checked': null }} name="position" value="2">
                                        <span></span>Sol</label>
                                    <label class="radio">
                                        <input form="submit-form"  type="radio" {{ old('position',$onlineCatalog->position) == 1 ? 'checked': null }} name="position" value="1">
                                        <span></span>Orta</label>
                                    <label class="radio">
                                        <input form="submit-form" type="radio" {{ old('position',$onlineCatalog->position) == 3 ? 'checked': null }}  name="position" value="3">
                                        <span></span>Sağ</label>
                                </div>
                            </div>
                                        ...
                                        @foreach(cache('key-all-languages') as $key => $language)
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="images-post-item imageLoad">


                                                        <div
                                                            style="{{ old('image.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'image')) == null?"display:none;":"display:flex;" }}"
                                                        ...
                                                        >
                                                            ...
                                                            <img
                                                                src="{{ old('image.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'image')) == null?asset('storage/no-image.png'): old('image.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'image')) }}"
                                                ...
                                                <div class="image-post-input">
                                                    <input type="text"
                                                           ...
                                                           value="{{ old('image.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'image')) == null? '': old('image.'. $language->id,getTranslateData($onlineCatalog->onlineCatalogsTranslations,$language->id,'image')) }}"
