...
{{--                                    </li>--}}
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.product.update') }}"
                                  method="POST"
                            >
                                @csrf
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                <input type="text" name="special_price"
                                                                                       autocapitalize="OFF"
                                                                                       value="{{ old('special_price',$product->productSpecialPriceList != null ? $product->productSpecialPriceList['special_price'] : '') }}"
                                                                                       class=" form-control">
                                                                             ...
                                                                             class="span-dvidder">Başlama tarixi</span>
                                                                                <div class="input-group date"
                                                                                    ...
                                                                                    <input type="text"
                                                                                           ...
                                                                                           value="{{ old('special_price_start_date',$product->productSpecialPriceList != null ? $product->productSpecialPriceList['start_date'] : '') }}"
                                                                             ...
                                                                             <span
                                                                                ...
                                                                                <div class="input-group date"
                                                                                    ...
                                                                                    <input type="text"
                                                                                           ...
                                                                                           value="{{ old('special_price_end_date', $product->productSpecialPriceList != null ? $product->productSpecialPriceList['end_date'] : '') }}"
                                                ...
                                                <div style="padding: 0.25rem;" class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <small>Cədvəlin borderinə <b
                                                                    class="text-danger">(#D8D8D8)</b> bu rəng kodunu və
                                                                ya
                                                ...
                                                <div style="padding: 0.25rem;" class="card-body">
                                                    ...
                                                    <table class="table-responsive-my">
                                                        ...
                                                        @else
                                                            ...
                                                            <!--  TR START  -->
                                                            @isset($product->getProductAttributeList[0]->product_id)
                                                                @foreach($product->getProductAttributeList as $attributeList)
                                                                    <tr class="attributeTr">
                                                                        <td data-label="Atribut" tabindex="1">
                                                                            <div class="attribute-box-container">
                                                                                <input type="text" placeholder="Atribut"
                                                                                       value="@isset($attributeList->attribute_id){{ \App\Services\AttributeService::getAttributeName($attributeList->attribute_id) }}@endisset"
                                                                                       class="form-control attributeSearch">
                                                                                <input type="hidden" form="submit-form"
                                                                                       class="attributeInput"
                                                                                       name="attribute_list[][attribute_id]"
                                                                                       value="{{ $attributeList->attribute_id }}">
                                                                                <div tabindex="1"
                                                                                     class="attribute-box-item">
                                                                                    <!--  CODE  -->
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                          ...
                                                                          <img width="24"
                                                                               src="{{ countryFlag($language->code) }}"/>
                                                                                            ...
                                                                                            <textarea
                                                                                                ...
                                                                                                placeholder="Text"
                                                                                            >{{ getTranslateAttributeData($product->getProductAttributeListAll,$language->id,$attributeList->attribute_id,'name') }}</textarea>
                                                                                        </div>
                                                                                    @endforeach
                                                                                ...
                                                                                <div
                                                                                    class="col-md-1 removeButtonAttribute">
                                                                                    <div
                                                                                        class="attribute-box-delete-container">
                                                                                        <div
                                                                                            class="attribute-box-delete">
                                                                    ...
                                                                    @else
                                                                                ...
                                                                                @foreach($options as $option)
                                                                                    ...
                                                                                    <li class="nav-item">
                                                                                        <a class="nav-link @if($loop->first) active @endif"
                                                                                           id="option_tabs-id-{{$option->product_option_list_id}}"
                                                                                           data-toggle="tab"
                                                                                           href="#option_tabs-{{$option->product_option_list_id}}"
                                                                                           aria-controls="option_tabs-{{$option->product_option_list_id}}">
                                                                                            <span class="nav-icon"><i
                                                                                                    class="fa fa-minus-circle"></i></span>
                                                                                            <span
                                                                                                class="nav-text">{{ $option->name }}</span>
                                                                                            <input type="hidden"
                                                                                                   value="{{ $option->name }}"
                                                                                                   name="option_list[option_name][]">
                                                                                            <input type="hidden"
                                                                                                   value="{{ $option->option_id }}"
                                                                                                   name="option_list[option_id][]"
                                                                                                   class="optionID">
                                                                                            <input type="hidden"
                                                                                                   value="{{ $option->type }}"
                                                                                                   name="option_list[option_type][]"
                                                                                                   class="optionType">
                                                                                        </a>
                                                                                    </li>
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            ...
                                                                            <div class="tab-content optionContent"
                                                                                 style="padding-top: 0">
                                                                                @foreach($options as $option)
                                                                                        <?php $makeRandomID = generateRandomString(20) ?>


                                                                                    <div
                                                                                        class="tab-pane @if($loop->first) active show @endif"
                                                                                        id="option_tabs-{{$option->product_option_list_id}}"
                                                                                        data-uniq-id="{{ $makeRandomID }}"
                                                                                        role="tabpanel"
                                                                                        aria-labelledby="option_tabs-id-{{$option->product_option_list_id}}">


                                                                                        <div
                                                                                            class="table-responsive table table-striped table-hover">
                                                                                            <table class="table">
                                                                                                <thead
                                                                                                    class="thead-light">
                                                                                                <tr>
                                                                                                ...
                                                                                                @foreach($optionsValues as $optionsValueKey => $optionsValue)
                                                                                                        <?php $imgClassname = generateRandomString(20); ?>
                                                                                                    {{-- @if($option->option_id == $optionsValue->option_id)--}}
                                                                                                        @if($option->option_value_id == $optionsValue->option_value_id)
                                                                                                        ...
                                                                                                        <tr class="optionTr">
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <select
                                                                                                                            form="submit-form"
                                                                                                                            class="form-control colum-option-box"
                                                                                                                            name="option_list[option_value_id][{{ $optionsValue->type == 1 ? 'image_and_text' : 'text' }}][{{ $makeRandomID }}][]">


                                                                                                                            @foreach($optionValuesData as $optionVal)
                                                                                                                                @if($optionVal->option_id == $optionsValue->option_id)
                                                                                                                                    <option
                                                                                                                                        value="{{ $optionVal->id }}"
                                                                                                                                        @if($optionsValue->option_value_id == $optionVal->id) selected @endif
                                                                                                                                    >{{ $optionVal->text }}</option>
                                                                                                                                @endif
                                                                                                                            @endforeach
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <!--  IMAGES START  -->
                                                                                                                                <div
                                                                                                                                    class="images-post-container-option"
                                                                                                                                    data-class-name="{{ $imgClassname }}">
                                                                                                                                    <div
                                                                                                                                        class="images-post-items"
                                                                                                                                        style="width: 100px; height: 100px">

                                                                                                                                        <div
                                                                                                                                            @if($optionsValue->image == '')
                                                                                                                                                style="display: none"
                                                                                                                                            @else
                                                                                                                                                style="display: flex;"
                                                                                                                                            @endif
                                                                                                                                        ...
                                                                                                                                        <figure
                                                                                                                                            ...
                                                                                                                                            <img
                                                                                                                                                style="width: 100px; height: 100px"
                                                                                                                                                src="{{ $optionsValue->image == '' ? asset('storage/no-image.png') : $optionsValue->image }}"
                                                                                                                                ...
                                                                                                                                <!--  IMAGE INPUT  -->
                                                                                                                                <div
                                                                                                                                    class="image-post-input">
                                                                                                                                    <input
                                                                                                                                        type="text"
                                                                                                                                        id="image_label-{{ $imgClassname }}"
                                                                                                                                        name="option_list[image][image_and_text][{{ $makeRandomID }}][]"
                                                                                                                                        value="{{ $optionsValue->image != '' ? $optionsValue->image : '' }}"
                                                                                                                                        form="submit-form">
                                                                                                            ...
                                                                                                            <td class="colum-sort-box">
                                                                                                                <div
                                                                                                                    class="colum-sort" style="width: 100px">
                                                                                                                    <input
                                                                                                                        type="number"
                                                                                                                        form="submit-form"
                                                                                                                        step=".01"
                                                                                                                        min="0"
                                                                                                                        class="form-control"
                                                                                                                        name="option_list[price][{{ $optionsValue->type == 1 ? 'image_and_text' : 'text' }}][{{ $makeRandomID }}][]"
                                                                                                            ...
                                                                                                            <td class="colum-sort-box">
                                                                                                                <div class="colum-sort">
                                                                                                                    <input
                                                                                                                        ...
                                                                                                                        min="0"
                                                                                                                        class="form-control"
                                                                                                                        name="option_list[option_special_price][{{ $optionsValue->type == 1 ? 'image_and_text' : 'text' }}][{{ $makeRandomID }}][]"
                                                                                                                        value="{{ $optionsValue->option_special_price }}"
                                                                                                                        placeholder="Endirimli qiymət">

                                                                                                                </div>
                                                                                                                <div class="colum-sort mt-2">
                                                                                                                    <input style="width: 163px;"
                                                                                                                           name="option_list[option_start_date][{{ $optionsValue->type == 1 ? 'image_and_text' : 'text' }}][{{ $makeRandomID }}][]"
                                                                                                                           type="datetime-local"
                                                                                                                           value="{{ $optionsValue->option_start_date }}"
                                                                                                                           class="form-control">
                                                                                                                </div>
                                                                                                                <div class="colum-sort mt-2">
                                                                                                                    <input style="width: 163px;"
                                                                                                                           name="option_list[option_end_date][{{ $optionsValue->type == 1 ? 'image_and_text' : 'text' }}][{{ $makeRandomID }}][]"
                                                                                                                           type="datetime-local"
                                                                                                                           value="{{ $optionsValue->option_end_date }}"
                                                                                                                           class="form-control">
                                                                                                                </div>
                                                                                                            </td>
                                                                                                            ...
                                                                                                            <td class="colum-sort-box">
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <input
                                                                                                                        ...
                                                                                                                        min="0"
                                                                                                                        class="form-control"
                                                                                                                        name="option_list[sort][{{ $optionsValue->type == 1 ? 'image_and_text' : 'text' }}][{{ $makeRandomID }}][]"
                                                                                                                        value="{{ $optionsValue->sort }}"
                                                                                                                        placeholder="Sıra">
                                                                                                                </div>
                                                                                                            </td>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <div
                                                                                                                    class="removeButtonOption">
                                                                                                                    <div
                                                                                                                        class="option-box-delete-container">
                                                                                                                        <div
                                                                                                                            class="option-box-delete">
                                                                                                                            <i class="fa fa-minus-circle"></i>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                        ...
                                                                                        <div
                                                                                            class="option-box-add-container">
                                                                    ...
                                                                    @foreach(cache('key-all-languages') as $key => $language)
                                                                        <div class="input-group mt-2">
                                                                            ...
                                                                            <input
                                                                                style="height: 21px;"
                                                                                type="text" readonly
                                                                                value="{{$language->code == cache('language-default') ? "": "/".$language->code}}/product/{{ $product->slug }}"
                                                                                class="form-control">
                                                                        </div>
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <!--  ID  -->
                            <input type="hidden" form="submit-form" name="id" value="{{ $product->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        <option {{ $product->status == 1?'selected':'' }} value="1">Aktiv</option>
                                        <option {{ $product->status == 0?'selected':'' }} value="0">Passiv</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ \Illuminate\Support\Carbon::parse($product->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
                                ...
                                <div style="width: 100%" class="form-group">
                                    <select form="submit-form" class="form-control countriesOverflow selectpicker"
                                        ...
                                        @foreach($models as $model)
                                            @if(!old('model') != null)
                                                @isset($product->getProductModel->model_id)
                                                    <option
                                                        {{ old('model',$model->id) == $product->getProductModel->model_id ? 'selected' : '' }} value="{{ $model->id }}">{{ $model->name  }}</option>
                                                @else
                                                    <option value="{{ $model->id }}">{{ $model->name  }}</option>
                                                @endisset
                                            @else
                                                <option
                                                    {{ old('model',$model->id) == $model->id ? 'selected' : '' }} value="{{ $model->id }}">{{ $model->name  }}</option>
                                            @endif
                                        @endforeach
                            ...
                            <div class="form-group row">
                                <div style="width: 100%" class="form-group">
                                    <div class="checkbox-list categories-list">
                                        ...
                                        {{ \App\Services\CategoriesService::getTreeEditProductCategories($defaultLanguage,0,$selectCategories) }}
                            ...
                            <div class="form-group row">
                                <div style="width: 100%" class="form-group">
                                    <div class="checkbox-list categories-list">
                                        ...
                                        {{ \App\Services\CollectionsService::getTreeEditProductCollections($defaultLanguage,0,$selectCollections) }}
                                    ...
                                    <select form="submit-form" class="form-control countriesOverflow selectpicker"
                                        ...
                                        @foreach($manufacturers as $manufacturer)
                                            @if(!old('manufacturer') != null)
                                                @isset($product->getProductManufacturer->manufacturer_id)
                                                    <option
                                                        {{ old('manufacturer',$manufacturer->id) == $product->getProductManufacturer->manufacturer_id ? 'selected' : '' }} value="{{ $manufacturer->id }}">{{ $manufacturer->name  }}</option>
                                                @else
                                                    <option
                                            ...
                                            @else
                                                <option
                                                    {{ old('manufacturer',$manufacturer->id) == $manufacturer->id ? 'selected' : '' }} value="{{ $manufacturer->id }}">{{ $manufacturer->name  }}</option>
                                            @endif
                                        @endforeach
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div
                                        ...
                                        <div class="images-post-item">
                                            ...
                                            <div
                                                style="display: {{ old('image',$product->image) == null? 'none':'flex' }}"
                                                tooltip="Sil"
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{old('image',$product->image) == null ? asset('storage/no-image.png'): old('image',$product->image) }}"
                                                    class="previewImage"
                                                >
            ...
            ajax: {
                ...
                data: function (params) {
                    return {
                        ...
                        parent_id: {{ old('parent', $product->parent) }}
                    };
                },
            },
        });
            ...
            ajax: {
                ...
                data: function (params) {
                    return {
                        q: params.term, // search term
                        product_id: {{ $product->id }},
                        gallery_id: {{ old('gallery', $product->getProductGallery == null ? 0 : $product->getProductGallery['gallery_id']) }}
                    };
                },
            },
        });
