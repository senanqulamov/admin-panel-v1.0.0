...
<head>
    <meta charset="utf-8">
    <title>Amiso | Web Design Agency HTML Template</title>
    <!-- Stylesheets -->
                ...
                <div class="col-xl-12">
                    <div class="error-page__inner">
                        <div class="error-page__title-box">
                            <img src="{{ asset('frontend/assets/images/resource/404.jpg') }}" alt="">
                            <h3 class="error-page__sub-title">{!! language('general.404_page') !!}</h3>
                        </div>
