            ...
            <div class="row">
                <div class="col-my-lg-8 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body">
                            <form class="form" id="submit-form" action="{{ route('admin.gallery.update') }}"
                                  method="POST"
                            >
                                @csrf
                                                            ...
                                                            <div class="tab-content">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('name.'. $language->id,getTranslateData($gallery->galleriesTranslations,$language->id,'name')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class="tinymceEditor form-control">{{ old('text.'. $language->id,getTranslateData($gallery->galleriesTranslations,$language->id,'text')) }}</textarea>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" name="created" autocapitalize="OFF"
                                                                           value="{{ old('created', $gallery->created != null ? \Illuminate\Support\Carbon::parse($gallery->created)->format('Y-m-d'): null) }}"
                                                                           class=" form-control">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('title.'. $language->id,getTranslateData($gallery->galleriesTranslations,$language->id,'title')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value="{{ old('keyword.'. $language->id,getTranslateData($gallery->galleriesTranslations,$language->id,'keyword')) }}"
                                                                                class=" form-control">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea
                                                                                ...
                                                                                class=" form-control">{{ old('description.'. $language->id,getTranslateData($gallery->galleriesTranslations,$language->id,'description')) }}</textarea>
                                                                    ...
                                                                    @foreach(cache('key-all-languages') as $key => $language)
                                                                        <div class="input-group mt-2">
                                                                            ...
                                                                            <input
                                                                                style="height: 21px;"
                                                                                type="text" readonly
                                                                                value="{{$language->code == cache('language-default') ? "": "/".$language->code}}/gallery/{{ $gallery->slug }}"
                                                                                class="form-control">
                                                                        </div>
                                                                                ...
                                                                                @foreach(json_decode($gallery->images,true)['type'] as $filesDataTypeKey => $filesDataTypeValue)
                                                                                    @if($filesDataTypeValue == 1)
                                                                                        ...
                                                                                        <div class="images-box-item">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div data-element-type="1"
                                                                                                     data-element-url="{{ $filesLinks[$filesDataTypeKey] }}"
                                                                                                     class="fa fa-eye showImageOrVideoModalButton"
                                                                                                     data-toggle="modal"
                                                                                                     data-target="#showImageOrVideoModalButton"></div>
                                                                                            </div>
                                                                                            <img width="200"
                                                                                                 src="{{ $filesLinks[$filesDataTypeKey] }}">
                                                                                            <input form="submit-form"
                                                                                                   type="hidden"
                                                                                                   name="files[link][]"
                                                                                                   value="{{ $filesLinks[$filesDataTypeKey] }}">
                                                                                            <input form="submit-form"
                                                                                                   type="hidden"
                                                                                                   name="files[type][]"
                                                                                                   value="1">
                                                                                    ...
                                                                                    @if($filesDataTypeValue == 2)
                                                                                        <div class="images-box-item">
                                                                                            ...
                                                                                            <img width="200"
                                                                                                 src="https://img.youtube.com/vi/{{ $filesLinks[$filesDataTypeKey] }}/default.jpg">
                                                                                            <input form="submit-form"
                                                                                                   type="hidden"
                                                                                                   name="files[link][]"
                                                                                                   value="{{ $filesLinks[$filesDataTypeKey] }}">
                ...
                <div class="col-my-lg-4 ">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <!--  ID  -->
                            <input type="hidden" form="submit-form" name="id" value="{{ $gallery->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select form="submit-form" class="form-control" name="status">
                                        <option {{ $gallery->status == 1?'selected':'' }} value="1">Aktiv</option>
                                        <option {{ $gallery->status == 0?'selected':'' }} value="0">Passiv</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="save-tools-item">
                                        ...
                                        <div>{{ \Illuminate\Support\Carbon::parse($gallery->created_at)->format('Y-m-d H:i') }}</div>
                                    </div>
                                    <div class="save-tools-item">
                                        <div>Tarix yenilənmə:</div>
                                        <div>{{ updateDate($gallery->updated_at,$gallery->galleriesTranslations) }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <div  class="form-group">
                                        <div class="checkbox-list categories-list">
                                            <label  class="checkbox checkbox-success">
                                                <input form="submit-form" {{ $gallery->show_home == 1 ? 'checked':'' }} type="checkbox" name="show_home">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="sort" style="width: 78px" min="0" class="form-control" value="{{ old('sort',$gallery->sort) }}" form="submit-form">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div style="width: 100%" class="form-group">
                                    <div class="checkbox-list categories-list">
                                        ...
                                        {{ \App\Services\CategoriesService::getTreeEditGalleryCategories($defaultLanguage,0,$selectCategories) }}
                                ...
                                <div style="width: 100%" class="form-group">
                                    <select form="submit-form" class="form-control countriesOverflow selectpicker"
                                        ...
                                        @foreach($activities as $activity)
                                            @if(!old('activity') != null)
                                                @isset($gallery->getGalleryActivity->activity_id)
                                                    <option {{ old('activity',$activity->id) == $gallery->getGalleryActivity->activity_id ? 'selected' : '' }} value="{{ $activity->id }}">{{ $activity->name  }}</option>
                                                @else
                                                    <option
                                                        value="{{ $activity->id }}">{{ $activity->name  }}</option>
                                                @endisset
                                            @else
                                                <option {{ old('activity',$activity->id) == $activity->id ? 'selected' : '' }} value="{{ $activity->id }}">{{ $activity->name  }}</option>
                                            @endif
                                        @endforeach
                                ...
                                <div style="width: 100%" class="form-group">
                                    <select form="submit-form" class="form-control countriesOverflow selectpicker"
                                        ...
                                        @foreach($countries as $country)
                                            @if(!old('country') != null)
                                                @isset($gallery->getGalleryCountry->country_id)
                                                    <option
                                                        {{ old('country',$country->id) == $gallery->getGalleryCountry->country_id ? 'selected' : '' }} value="{{ $country->id }}">{{ $country->name  }}</option>
                                                @else
                                                    <option
                                            ...
                                            @else
                                                <option
                                                    {{ old('country',$country->id) == $country->id ? 'selected' : '' }} value="{{ $country->id }}">{{ $country->name  }}</option>
                                            @endif
                                        @endforeach
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <div
                                        ...
                                        <div class="images-post-item">
                                            ...
                                            <div
                                                style="display: {{ old('image',$gallery->image) == null? 'none':'flex' }}"
                                                tooltip="Sil"
                                            ...
                                            >
                                                ...
                                                <img
                                                    src="{{old('image',$gallery->image) == null ? asset('storage/no-image.png'): old('image',$gallery->image) }}"
                                                    class="previewImage"
                                                >
