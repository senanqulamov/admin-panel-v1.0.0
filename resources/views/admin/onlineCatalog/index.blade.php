        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Onlayn Kataloqlar</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        @isset($searchText)
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.language.index') }}" class="text-muted">Onlayn Kataloqlar</a>
                            </li>
                            <li class="breadcrumb-item">
                                Axtar
                            </li>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Onlayn Kataloqlar</h3>
                    </div>
                            ...
                            <tr class="table-id-{{ $onlineCatalog->id }}" data-index="{{ $onlineCatalog->id }}" data-position="{{ $onlineCatalog->sort }}">
                                ...
                                <td width="100">
                                        ...
                                        <label>
                                            <input
                                                class="statusActive"
                                                data-id="{{ $onlineCatalog->id }}"
                                                type="checkbox"
                                                {{ $onlineCatalog->status == 1? 'checked="checked"':"" }}
                                                name="select">
                                            <span></span>
                                        </label>
									</span>
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right"
                                            ...
                                            <ul class="navi navi-hover">
                                                ...
                                                <li
                                                    ...
                                                    <a href="{{ route('admin.onlineCatalog.edit',$onlineCatalog->id) }}" class="navi-link text-center">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div class="d-flex align-items-center py-3">
                            <span class="text-muted">
                                Cəmi <b><span class="totalCount">{{ $onlineCatalogs->total() }}</span></b> yazı
                                @if($onlineCatalogs->hasPages())
                                    , <b>{{ $onlineCatalogs->lastPage() }}
                                </b> səhifədən  <b>{{ $onlineCatalogs->currentPage() }}</b>-ci göstərildi.
                                @endif
                        ...
                        <div class="d-flex flex-wrap py-2 mr-3">
                            {{ $onlineCatalogs->appends(['search' => isset($searchText) ? $searchText : null])
    ...
    <script>
        $(function () {
            ...
            $(document).on('click', '.statusActive', function () {
                ...
                $.ajax({
                    url: "{{ route('admin.onlineCatalog.statusAjax') }}",
                    type: 'POST',
        ...
        function saveNewPositions() {
            ...
            $.ajax({
                url: "{{ route('admin.onlineCatalog.sortAjax') }}",
                method: 'POST',
                dataType: 'JSON',
        ...
        $(document).on('click', '.deleteButton', function () {
            var onlineCatalogID = $(this).data('id');

            $.ajax({
                url: "{{ route('admin.onlineCatalog.deleteAjax') }}",
                type: 'POST',
                data: {id: onlineCatalogID},
                dataType: 'JSON',
                success: function (response) {
                    if (response.success) {
                        ...
                        Swal.fire({
                            title: "Diqqət?",
                            html: "Onlayn Kataloqı silmək istədiyinizə əminsiniz?",
                            icon: "error",
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                    url: "{{ route('admin.onlineCatalog.delete') }}",
                                    type: 'POST',
                                    data: {id:onlineCatalogID},
                                    dataType: 'JSON',
                                    success: function (response) {
                                        ...
                                        if (response.success) {
                                            $('.table-id-'+onlineCatalogID).fadeOut(1000);
